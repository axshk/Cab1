        ...
        <div class="row row-cols-1 row-cols-sm-2 row-cols-md-4 g-3">
            <div class="col">
                <div class="card shadow-sm">
                    <img src="mini.png" alt="cd" height="250px">
            ...
            <div class="col">
                <div class="card shadow-sm">
                    <img src="sedan.png" alt="cd" height="250px">
            ...
            <div class="col">
                <div class="card shadow-sm">
                    <img src="suv.png" alt="cd" height="250px">
            ...
            <div class="col">
                <div class="card shadow-sm">
                    <img src="lux.png" alt="cd" height="250px">
            ...
            <div class="col-md-6">
                <div
                    ...
                    <div class="col-auto d-none d-lg-block">
                        <img src="budget.png" alt="error" height="240" width="360">
                    </div>
                </div>
            </div>
            <div class="col-md-6">
                <div
                    ...
                    <div class="col-auto d-none d-lg-block">
                        <img src="secure1.png" alt="error" height="240" width="360">
        ...
        <div class="row mb-2">
            <div class="col-md-6">
                <div
                    ...
                    <div class="col-auto d-none d-lg-block">
                        <img src="netflix.png" alt="error" height="240" width="360">
            ...
            <div class="col-md-6">
                <div
                    ...
                    <div class="col-auto d-none d-lg-block">
                        <img src="cash.png" alt="error" height="240" width="360">
                    </div>
                </div>
            </div>
        </div>
